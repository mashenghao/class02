...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        initData();
        mIn_vp.setAdapter(new MyPagerAdatper(mViewList));
        addDots();
        moveDots();
    }
    ...
    private void initData() {
        ...
        View view1 = lf.inflate(R.layout.welcome_01, null);
        View view2 = lf.inflate(R.layout.welcome_02, null);
        View view3 = lf.inflate(R.layout.welcome_03, null);
        mViewList.add(view1);
        mViewList.add(view2);
        mViewList.add(view3);
    }
